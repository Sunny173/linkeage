...
package com.oo2oo.linkage.wheelview;
...
import com.oo2oo.linkage.wheelview.adapter.WheelViewAdapter;
import com.oo2oo.linkage.wheelview.listener.OnWheelChangedListener;
import com.oo2oo.linkage.wheelview.listener.OnWheelClickedListener;
import com.oo2oo.linkage.wheelview.listener.OnWheelScrollListener;
import com.oo2oo.linkage.wheelview.listener.WheelScroller;
...
public class WheelView extends View {
     ...
     * @return
     */
    public static GradientDrawable getBackgroundDrawable(int strokeColor, int drawableColor, int strokeWidth, float radius) {
    ...
    private void initResourcesIfNecessary() {
        if (centerDrawable == null) {
            centerDrawable = getBackgroundDrawable(Color.parseColor("#C7C7C7"),
